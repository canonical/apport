...
* packaging: drop `get_native_multiarch_triplet` method
...
* test:
  ...
  - add type hint to `_CACHE` (needed for mypy 2.1)
...
Bug fixes:
 - launchpad.py: Drop APPORT_FILES inclusion list for download() and instead
