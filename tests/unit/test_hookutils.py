...
class TestHookutils(unittest.TestCase):
    ...
    def test_anonymized_udevdb(self) -> None:
        # One device entry with an ext4 filesystem named "john-doe-rootfs"
        # Many properties have been removed to make the test case cleaner
        udevdb = """
P: /devices/pci0000:00/0000:00:04.0/virtio2/block/vda/vda1
S: disk/by-path/pci-0000:00:04.0-part/by-label/john-doe-rootfs
S: disk/by-label/john-doe-rootfs
E: DEVPATH=/devices/pci0000:00/0000:00:04.0/virtio2/block/vda/vda1
E: DEVNAME=/dev/vda1
E: ID_FS_LABEL=john-doe-rootfs
